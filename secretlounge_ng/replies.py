...
format_strs = {
	...
	types.MESSAGE_DELETED:
		em(
			"Your message has been deleted. No cooldown has been "
	...
	types.ERR_SIGN_PRIVACY: em(
		"Your account privacy settings prevent usage of the sign feature. Enable linked forwards first."
		),
